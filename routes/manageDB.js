module.exports = {
    ...
    fillsDB: function () {
        db.connect(function(err) {
          ...
          sql = "INSERT IGNORE INTO Hexes (Xcoord, Ycoord, LayerId, FillId, TagId, Text, Info) VALUES (1, -1, 1, 2, 1, '', '')"
          db.query(sql, function (err, result) {
              if (err) throw err;
              console.log("Hex table added hex");
          });
          ...
          sql = "INSERT IGNORE INTO Hexes (Xcoord, Ycoord, LayerId, FillId, TagId, Text, Info) VALUES (0, -1, 1, 9, 5, '', '')"
          db.query(sql, function (err, result) {
              if (err) throw err;
              console.log("Hex table added hex");
          });

          sql = "INSERT IGNORE INTO Hexes (Xcoord, Ycoord, LayerId, FillId, TagId, Text, Info) VALUES (0, 0, 2, 1, 1, 'FeyHome', '')"
          db.query(sql, function (err, result) {
              if (err) throw err;
              console.log("Hex table added hex");
          });
